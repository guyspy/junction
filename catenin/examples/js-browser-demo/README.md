...
./gradlew :catenin:examples:js-browser-demo:jsBrowserDistribution
# Then open: catenin/examples/js-browser-demo/build/distributions/index.html
```

## How it Works

The demo creates a simple web interface that loads the Catenin game engine as a JavaScript module and demonstrates basic game functionality in the browser.
