...
This directory contains examples demonstrating how to use the Cadherin game engine library.
...
These examples are **not part of the published library**. They are standalone demonstrations that show how to use the published Cadherin library.
...
The JVM demo shows the basic pattern for using Cadherin:
