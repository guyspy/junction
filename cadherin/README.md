...
Cadherin is part of the Junction educational gaming platform. It provides a unified API that compiles to both JVM (server) and JavaScript (frontend), allowing shared game logic across platforms.
...
```javascript
import { GameEngine } from './cadherin-core.js'
...
Cadherin is designed for AI agent modification:
...
**Cadherin** - *Building educational games, one card at a time* 🎴