# Cadherin Library Structure

## What Gets Published

The Cadherin library contains **only** the core game engine functionality:

### Core Library (commonMain)
```
src/commonMain/kotlin/org/junction/cadherin/
├── core/
...
implementation("org.junction:cadherin:1.0.0-SNAPSHOT")
