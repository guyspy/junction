...
將 Catenin 重構為標準的 SDK + Examples monorepo 架構，提供清晰的核心庫與示例項目分離，支援多平台獨立項目引用。

## 📁 新的 Monorepo 結構

```
junction/
├── catenin/                        # 核心 SDK (移除 -sdk 後綴)
...
[libraries]
catenin = { module = "org.junction.catenin:catenin", version.ref = "catenin" }
...
- [ ] 重新組織目錄結構
- [ ] 設置根項目 Gradle 配置
- [ ] 更新 Catenin 核心庫的 build.gradle.kts
