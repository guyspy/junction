# Cadherin DSL - Kotlin Multiplatform 遊戲引擎

## 專案概述

Cadherin 是 Junction 平台的教育卡牌遊戲引擎，採用 **Kotlin Multiplatform** 架構，核心邏輯編譯為前後端共享的程式庫。使用 YAML DSL 定義遊戲規則，專為 AI Agent 驅動的遊戲創作設計。

## 核心理念

### **跨邊界的蛋白質**
如同細胞膜上的 cadherin 蛋白，此引擎跨越前後端邊界：
...
```typescript
import { GameEngine, ActionResult } from './cadherin-core'
